...
class CustomTheme {
  ...
  static final ThemeData classicLight = ThemeData(
      ...
      buttonTheme: ButtonThemeData(height: 36, layoutBehavior: ButtonBarLayoutBehavior.padded, minWidth: 88, padding: EdgeInsets.symmetric(horizontal: 16), alignedDropdown: false, colorScheme: ColorScheme(brightness: Brightness.light, primary: Color(0xff1f6c2f), primaryContainer: Color(0xffb3f2b2), onPrimary: Color(0xffffffff), onPrimaryContainer: Color(0xff002107), secondary: Color(0xff526350), secondaryContainer: Color(0xffd4e8d0), onSecondaryContainer: Color(0xff101f10), onSecondary: Color(0xffffffff), error: Color(0xffba1a1a), errorContainer: Color(0xffffdad6), onError: Color(0xffffffff), inversePrimary: Color(0xff8bd88e), inverseSurface: Color(0xff2f312d), onErrorContainer: Color(0xff410002), onInverseSurface: Color(0xfff0f1eb), background: Color(0xfffcfdf7), onBackground: Color(0xff1a1c19), shadow: Color(0xff000000), surface: Color(0xfffcfdf7), surfaceTint: Color(0xff1f6c2f), surfaceVariant: Color(0xffdee5d9), tertiary: Color(0xff39656c), tertiaryContainer: Color(0xffbcebf2), onSurface: Color(0xff1a1c19), onSurfaceVariant: Color(0xff424940), onTertiary: Color(0xffffffff), onTertiaryContainer: Color(0xff001f23), outline: Color(0xff72796f), outlineVariant: Color(0xffc2c9bd))));
